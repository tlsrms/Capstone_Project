...
function ProfileSelectPage() {
    ...
    const handleSelect = async (profileType) => {
        ...
        // 일단 localStorage에만 저장 (백엔드 연동은 나중에)
        localStorage.setItem('user_occupation', profileType);
        
        // 선택 애니메이션 보여주고 메인으로 이동
        setTimeout(() => {
            ...
            <div style={{
                ...
                {profiles.map((profile) => (
                    <div
                        ...
                        style={{
                            backgroundColor: selectedProfile === profile.id ? profile.color : '#2d2d2d',
                            ...
                            position: 'relative',
                            overflow: 'hidden',
                            opacity: isSubmitting && selectedProfile !== profile.id ? 0.5 : 1,
                            transform: selectedProfile === profile.id ? 'scale(1.05)' : 'scale(1)'
                        }}
                        onMouseOver={(e) => {
                            if (!isSubmitting && selectedProfile !== profile.id) {
                    ...
                    >
                        ...
                        <div style={{
                            fontSize: '4rem',
                            marginBottom: '1rem',
                            filter: selectedProfile === profile.id 
                        ...
                        <p style={{
                            fontSize: '0.9rem',
                            color: selectedProfile === profile.id ? '#fff' : '#a0a0a0',
                            fontWeight: selectedProfile === profile.id ? '500' : '400'
                        }}>
                            {profile.description}
                        </p>
